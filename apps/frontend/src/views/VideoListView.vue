...
<template>
  <main class="videos-shell ei-shell-bg text-foreground">
    <div class="list-page">
...
/* .eyebrow, .eyebrow-kohaku are global — see styles/editorial.css. */
...
/* Filter bar + chip primitives are global — see styles/editorial.css.
   Local override: the video list wants tighter vertical rhythm. */
.filter-bar {
  padding-top: 18px;
  padding-bottom: 24px;
  margin-top: 16px;
