          ...
          >
            <div class="practice-feedback-head">
              ...
              <HankoSeal
                ...
                label="正解"
                :aria-label="$t('practice.correct')"
                :rotation="-5"
                :size="56"
                class="practice-hanko"
              />
            </div>
        ...
        <template v-else-if="mode === 'vocab_meaning' && currentVocab && mcq">
          ...
          <ol class="practice-footnotes">
            <ChoiceFootnote
              ...
              :index="i"
              lang="zh-Hant"
              :selected="feedback === 'idle' && selectedChoice === i"
              :selected-label="''"
              :result="feedback === 'idle' ? null : (i === mcq.correctIndex ? 'correct' : (selectedChoice === i ? 'incorrect' : null))"
              :result-label="$t('exam.answer_tag')"
              :disabled="feedback !== 'idle'"
              @select="checkMeaning(i)"
            />
          </ol>
          ...
          >
            <div class="practice-feedback-head">
              ...
              <span class="practice-feedback-answer" lang="zh-Hant">
...
.practice-footnotes {
  list-style: none;
  margin: 0;
  padding: 0 0 0 22px;   /* room for ChoiceFootnote's proofreader margin dot */
  display: flex;
...
.practice-hanko { margin-left: auto; }
